        ...
        {generating && (
          ...
          >
            <motion.div
              initial={{ y: 20 }}
              animate={{ y: 0 }}
              className="bg-[#0A192F] border border-white/10 rounded-2xl p-8 w-full max-w-md shadow-2xl"
            >
              <div className="relative h-40 mb-6 overflow-hidden">
                <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-20 h-4 bg-[#2979FF]/20 rounded-full blur-md" />

                <motion.div
                  initial={{ y: 0 }}
                  animate={{
                    y: generatingProgress < 100 ? [0, -6, 0] : -160,
                  }}
                  transition={
                ...
                >
                  <div className="relative">
                    <motion.div
                      ...
                      className="absolute -bottom-6 left-1/2 -translate-x-1/2 w-4 h-8"
                      style={{
                    ...
                    <motion.div
                      ...
                      className="absolute -bottom-4 left-1/2 -translate-x-1/2 w-2 h-6"
                      style={{
                    ...
                    <div className="w-12 h-20 bg-gradient-to-b from-white to-gray-200 rounded-t-full relative shadow-lg">
                      <div className="absolute top-2.5 left-1/2 -translate-x-1/2 w-4 h-4 bg-[#0A192F] rounded-full" />
                      <div className="absolute bottom-0 left-0 w-2.5 h-5 bg-[#2979FF] -skew-x-12 -translate-x-1" />
                      <div className="absolute bottom-0 right-0 w-2.5 h-5 bg-[#2979FF] skew-x-12 translate-x-1" />
                      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-4 h-2.5 bg-[#06D6A0]" />
                    </div>
                  </div>
                </motion.div>
              ...
              <div className="space-y-3">
                <div className="flex justify-between text-sm">
                  <span className="text-gray-400 text-sm">{generatingStage}</span>
                  <span className="text-[#2979FF] font-semibold">{generatingProgress}%</span>
                </div>
                ...
                <div className="h-2 bg-white/10 rounded-full overflow-hidden">
                  <motion.div
                    ...
                    className="h-full bg-gradient-to-r from-[#2979FF] to-[#06D6A0] relative"
                  >
                    <motion.div
                      animate={{ x: ['-100%', '100%'] }}
