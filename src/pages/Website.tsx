            ...
            <div className="space-y-6">
              <div className="flex items-center justify-between flex-wrap gap-4">
                ...
                <div className="flex gap-3">
                  ...
                  <button
                    onClick={() => navigate(`/website-editor?id=${starterWebsite.id}`)}
                    className="flex items-center gap-2 px-4 py-2 bg-[#2979FF] text-white rounded-lg hover:bg-[#2979FF]/90 transition-all"
                  >
                    <Edit3 size={18} />
                    Edit Website
                  </button>
