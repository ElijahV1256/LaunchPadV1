          ...
          >
            ...
            >
              <div className="relative h-32 mb-6 flex items-center justify-center overflow-hidden">
                <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-16 h-3 bg-[#2979FF]/30 rounded-full blur-lg" />

                <motion.div
                  initial={{ y: 0 }}
                  animate={{
                    y: generatingProgress < 100 ? [0, -8, 0] : -140,
                  }}
                  transition={
                ...
                >
                  <motion.div
                    ...
                    className="absolute -bottom-4 left-1/2 -translate-x-1/2 w-6 h-10"
                    style={{
                      background: 'linear-gradient(to bottom, #FF6B35 0%, #FFD700 40%, transparent 100%)',
                      borderRadius: '0 0 50% 50%',
                      filter: 'blur(3px)',
                    }}
                  />

                  <div className="w-16 h-16 bg-gradient-to-br from-[#2979FF] to-[#06D6A0] rounded-2xl flex items-center justify-center shadow-lg shadow-[#2979FF]/30">
                  ...
                  >
                    {[...Array(6)].map((_, i) => (
                      <motion.div
                        ...
                        style={{ backgroundColor: ['#2979FF', '#06D6A0'][i % 2] }}
                      />
                    ))}
                  </motion.div>
                )}
