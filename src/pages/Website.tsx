...
export default function Website() {
  ...
  const loadData = async () => {
    try {
      const [brandResult, ideaResult, starterResult, proResult] = await Promise.all([
        supabase
          .from('brand_identity')
          ...
          {view === 'selection' && (
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-8 hover:border-[#2979FF]/50 transition-all group">
                ...
                <button
                  onClick={() => starterWebsite?.home_html ? setView('starter') : generateStarterWebsite()}
                  disabled={generating}
              ...
              <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl overflow-hidden">
                ...
                <div className="p-4">
                  ...
                  <div className="border border-white/10 rounded-lg overflow-hidden bg-white">
                    <iframe
                      srcDoc={activeTab === 'home' ? starterWebsite.home_html! : starterWebsite.shop_html!}
      ...
      <AnimatePresence>
        {generating && (
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="fixed inset-0 bg-[#0A192F]/95 backdrop-blur-md flex items-center justify-center z-50"
          >
            <div className="relative w-full max-w-lg px-8">
              <div className="relative h-80 mb-8">
                <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-32 h-8 bg-[#2979FF]/30 rounded-full blur-xl" />

                <motion.div
                  initial={{ y: 0 }}
                  animate={{
                    y: generatingProgress < 100 ? [0, -10, 0] : -300,
                  }}
                  transition={
                ...
                >
                  <div className="relative">
                    <motion.div
                      ...
                      className="absolute -bottom-12 left-1/2 -translate-x-1/2 w-8 h-16"
                      style={{
                    ...
                    <motion.div
                      ...
                      className="absolute -bottom-8 left-1/2 -translate-x-1/2 w-4 h-12"
                      style={{
                        background: 'linear-gradient(to bottom, #2979FF, transparent)',
                        borderRadius: '0 0 50% 50%',
                        filter: 'blur(2px)',
                      }}
                    />

                    <div className="w-20 h-32 bg-gradient-to-b from-white to-gray-200 rounded-t-full relative shadow-2xl">
                      <div className="absolute top-4 left-1/2 -translate-x-1/2 w-6 h-6 bg-[#0A192F] rounded-full" />
                      <div className="absolute bottom-0 left-0 w-4 h-8 bg-[#2979FF] -skew-x-12 -translate-x-2" />
                      <div className="absolute bottom-0 right-0 w-4 h-8 bg-[#2979FF] skew-x-12 translate-x-2" />
                      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-6 h-4 bg-[#06D6A0]" />
                    </div>

                    <Rocket className="absolute top-8 left-1/2 -translate-x-1/2 text-[#2979FF]" size={32} />
                  </div>
                </motion.div>
                  ...
                  >
                    {[...Array(12)].map((_, i) => (
                      <motion.div
                        ...
                        style={{ backgroundColor: ['#FFD700', '#FF6B35', '#2979FF', '#06D6A0'][i % 4] }}
                      />
                    ))}
                  </motion.div>
                )}
              ...
              <div className="space-y-4">
                <div className="flex justify-between text-sm mb-2">
                  <span className="text-gray-400">{generatingStage}</span>
                  <span className="text-[#2979FF] font-bold">{generatingProgress}%</span>
                </div>
                ...
                <div className="h-3 bg-white/10 rounded-full overflow-hidden relative">
                  <motion.div
                    ...
                    className="h-full bg-gradient-to-r from-[#2979FF] via-[#06D6A0] to-[#2979FF] relative"
                ...
                <p className="text-center text-gray-500 text-sm mt-6">
                  Building your professional website with AI...
                </p>
              </div>
            </div>
          </motion.div>
